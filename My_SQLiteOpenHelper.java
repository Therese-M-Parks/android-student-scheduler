...
//                    COUNTRY + " TEXT " + ")";
    ...
    //TODO: I must have a field to store my image for each family member

    public static final String FAMILY_MEMBER_TABLE = "Family_Member";
    //Columns
    public static final String FAMILY_MEMBER_ID = "_id";//PK
    public static final String KEY_FAMILY_IMAGE = "key_family_image";
    public static final String FIRST_NAME = "first";
    public static final String LAST_NAME = "last" ;
    public static final String EMERGENCY_CONTACT ="emergency_contact"; // set to 1 for yes, 0 for no
    ...
    public static final String BIRTH_DAY = "birthday"; //FK
    public static final String BIRTHDAY_CHECKED = "birthday_checked"; // set to 1 for yes, 0 for no
    ...
    public static final String[] ALL_FAMILY_MEMBER_COLUMNS = {
            FAMILY_MEMBER_ID, KEY_FAMILY_IMAGE, FIRST_NAME, LAST_NAME, EMERGENCY_CONTACT, FAM_MEMBER_RELATION_ID,
            PHONE_1, PHONE_2, EMAIL, BIRTH_DAY, BIRTHDAY_CHECKED, DESCRIPTION, RELATION_TITLE
    };
    ...
    private static final String CREATE_FAMILY_MEMBER_TABLE =
            "CREATE TABLE " + FAMILY_MEMBER_TABLE + " (" +
                    ...
                    KEY_FAMILY_IMAGE + " BLOB, " +
                    FIRST_NAME + " TEXT, " +
                    LAST_NAME + " TEXT, " +
                    EMERGENCY_CONTACT + " TEXT, " +
                    FAM_MEMBER_RELATION_ID + " TEXT, " + //FK
                    PHONE_1 + " TEXT, " +
                    PHONE_2 + " TEXT,  " +
                    EMAIL + " TEXT, " +
                    BIRTH_DAY + " DATE, " +
                    BIRTHDAY_CHECKED + " TEXT, " +
