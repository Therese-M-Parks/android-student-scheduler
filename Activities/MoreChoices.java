...
public class MoreChoices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //code for Notes button
        button_notes = (Button) findViewById(R.id.button_FamilyNotes);
   ...
   public void openFamilyNotes(){
        Intent intent = new Intent(MoreChoices.this, ListAll_Notes.class);
        startActivity(intent);
   }
